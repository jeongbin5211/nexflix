...
const Nav: React.FC = () => {
  ...
  return (
    <nav className={`nav ${show && "nav__black"}`}>
      <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Netflix_2015_logo.svg/170px-Netflix_2015_logo.svg.png" alt="Nexflix logo" className='nav__logo' onClick={() => (window.location.href="/")} />
